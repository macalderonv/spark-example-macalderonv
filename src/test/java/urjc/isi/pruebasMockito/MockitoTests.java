...
public class MockitoTests {
	...
	public void MockListSize() {
		...
		when(list.size()).thenReturn(10);// cuando se llame a list devuelve un 10.
		assertEquals(10, list.size()); // llamo a list size con el valor 10
	}

	@Test
	public void MockListSizeWithMultipleReturnValues() {
		List list = mock(List.class); //se crea un substituto de la clase list
		when(list.size()).thenReturn(10).thenReturn(20);//primero devuelve un 10 
